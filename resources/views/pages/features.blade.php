@php
    ...
    $colors = [
        ...
        'success' => ['bg' => 'bg-red-500', 'light' => 'bg-red-50/50', 'text' => 'text-red-700', 'shadow' => 'shadow-red-500/20'],
        'info' => ['bg' => 'bg-red-500', 'light' => 'bg-red-50/50', 'text' => 'text-red-700', 'shadow' => 'shadow-red-500/20'],
        ...
        'teal' => ['bg' => 'bg-red-500', 'light' => 'bg-red-50/50', 'text' => 'text-red-700', 'shadow' => 'shadow-red-500/20'],
...
<x-landing-layout>
    ...
    <div class="text-[#18181b] font-sans overflow-hidden">
        ...
        <!-- Hero Section -->
        <section class="pt-32 pb-24 relative overflow-hidden bg-[#eaf0ee]/30 border-b border-[#C70000]/10">
            <div class="absolute inset-0 z-0 pointer-events-none">
                <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-red-400/10 blur-[150px] rounded-full translate-x-1/4 -translate-y-1/4"></div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 reveal">
                <span class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-50 border border-red-100 shadow-sm text-red-700 text-xs font-bold uppercase tracking-widest mb-8">
                    <span class="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span> Cutting-Edge LIS
                </span>
                
                <h1 class="font-serif text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 text-[#18181b] leading-[1.1]">
                    Engineered for <br class="hidden md:block" />
                    <span class="text-brand-600 italic font-serif">Diagnostic Precision</span>
                </h1>
                
                <p class="text-lg md:text-xl text-[#18181b]/80 max-w-2xl mx-auto leading-relaxed font-semibold mb-10">
                ...
                <div class="w-full max-w-5xl mx-auto rounded-[2.5rem] border border-[#C70000]/15 shadow-2xl overflow-hidden bg-white p-3">
            ...
            <section class="py-24 bg-white/30 relative">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div class="reveal-left">
                        ...
                        <h3 class="font-serif text-4xl md:text-5xl font-extrabold mb-6 tracking-tight text-[#18181b] leading-tight">
                            {{ $features->first()->title }}
                        </h3>
                        
                        <p class="text-md md:text-lg text-[#18181b]/80 mb-10 leading-relaxed font-semibold">
                        ...
                        <div class="space-y-5">
                            @foreach(['Supports 200+ Analyzer Manufacturers', 'Real-time Hardware Synchronization', 'Zero Manual Data Entry Errors'] as $point)
                                <div class="flex items-center gap-4 group">
                                    ...
                                    <span class="text-[#18181b] font-bold text-sm">{{ $point }}</span>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="reveal-right">
                        <div class="relative">
                            <div class="absolute -inset-4 bg-gradient-to-tr from-brand-400/20 to-red-400/20 blur-2xl rounded-[3.5rem] opacity-70"></div>
                                    ...
                                    @foreach(['CBC Complete', 'Lipid Profile', 'Thyroid Panel', 'HbA1c'] as $test)
                                        <div class="flex items-center justify-between bg-zinc-900 border border-zinc-800 rounded-xl p-4 hover:border-brand-500/50 transition-colors cursor-default group">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <span class="text-[10px] text-red-400 font-bold bg-red-500/10 border border-red-500/20 px-2 py-1 rounded-md tracking-wider">
                                                    AUTO-SYNCED
                                                </span>
                                            </div>
                                        </div>
        ...
        <section class="py-24 bg-[#eaf0ee]/30 border-t border-[#C70000]/10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16 reveal">
                    <span class="text-xs font-bold text-[#C70000] uppercase tracking-widest mb-3 block">Complete Suite</span>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-fr">
                    @foreach($features as $i => $feature)
                        ...
                        @endphp
                        <div class="reveal delay-{{ ($i % 6) + 1 }} group relative bg-white/80 backdrop-blur-sm rounded-[2.2rem] p-8 border border-[#C70000]/10 shadow-sm hover:shadow-xl hover:border-brand-500/30 transition-all duration-500 hover:-translate-y-1 flex flex-col">
                            ...
                            <h5 class="text-xl font-bold text-[#18181b] mb-3">{{ $feature->title }}</h5>
                            <p class="text-sm text-[#18181b]/80 leading-relaxed font-semibold mb-auto">{{ $feature->description }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <!-- Call to Action -->
        <section class="py-32 bg-[#C70000] text-center relative overflow-hidden text-white">
            ...
            <div class="relative z-10 reveal max-w-3xl mx-auto px-4">
                <h2 class="font-serif text-5xl md:text-6xl font-extrabold text-white mb-6 tracking-tight">
                    Modernize Your <span class="text-red-200">Lab DNA</span>
                </h2>
                <p class="text-xl text-red-100 mb-10 font-medium">
                    Stop managing paper. Start managing health outcomes.
                </p>
                
                <a href="#contact" class="inline-flex justify-center items-center gap-2 px-10 py-5 bg-white text-[#C70000] rounded-full font-bold text-lg shadow-xl shadow-red-900/20 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
