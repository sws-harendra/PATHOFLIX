    ...
    <div class="text-[#0f2d2a] font-sans overflow-hidden">
        ...
        <section class="pt-32 pb-20 relative overflow-hidden bg-[#eaf0ee]/30 border-b border-[#0c5f56]/10">
            <div class="absolute inset-0 z-0 pointer-events-none">
                ...
                <div class="absolute bottom-0 right-0 w-[600px] h-[600px] bg-emerald-400/5 blur-[150px] rounded-full translate-y-1/4"></div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center reveal">
                ...
                <h1 class="font-serif text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-8 text-[#0f2d2a] leading-[1.1]">
                    {!! str_replace(
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-16 items-center">
                ...
                <div class="lg:col-span-5 reveal-left">
                    <div class="relative group">
                        <div class="absolute -inset-4 bg-gradient-to-tr from-brand-100 to-emerald-50 blur-2xl rounded-[3.5rem] opacity-70"></div>
                        
                        <div class="relative rounded-[2.5rem] bg-white aspect-[4/5] overflow-hidden border border-[#0c5f56]/15 shadow-2xl p-2.5">
                ...
                <div class="lg:col-span-7 reveal-right lg:pl-8">
                    <span class="text-xs font-bold text-[#0c5f56] uppercase tracking-widest mb-4 block">Heritage</span>
                    <h3 class="font-serif text-4xl md:text-5xl font-extrabold mb-8 tracking-tight text-[#0f2d2a]">
                        Built by <span class="text-brand-600 italic font-serif">Experts</span>,<br>for Professionals.
                    </h3>
                    <p class="text-md md:text-lg text-[#0f2d2a]/80 mb-12 leading-relaxed font-semibold">
                        {{ $aboutDesc }}
                    </p>

                    <div class="grid grid-cols-3 gap-6 pt-8 border-t border-[#0c5f56]/10">
                        @foreach([
                            ...
                            <div>
                                <p class="text-4xl font-extrabold text-[#0f2d2a] font-display mb-2">{{ $stat['value'] }}</p>
                                <p class="text-[10px] font-bold text-[#0c5f56] uppercase tracking-wider">{{ $stat['label'] }}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <!-- Our Pillars / Values -->
        <section class="py-24 bg-[#eaf0ee]/20 border-y border-[#0c5f56]/10">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    @foreach([
                        ...
                        <div class="reveal delay-{{ $i + 1 }} group bg-white/80 backdrop-blur-sm rounded-[2.2rem] p-10 border border-[#0c5f56]/10 shadow-sm hover:shadow-xl hover:border-brand-500/20 transition-all duration-500 hover:-translate-y-1">
                            ...
                            <h5 class="text-xl font-bold text-[#0f2d2a] mb-3">{{ $value['title'] }}</h5>
                            <p class="text-sm text-[#0f2d2a]/80 leading-relaxed font-semibold">{{ $value['desc'] }}</p>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <!-- Timeline Section -->
        <section class="py-24 bg-[#0b1f1d] relative overflow-hidden shadow-[inset_0_4px_24px_rgba(0,0,0,0.15)] text-[#f4f7f6]">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="relative">
                    <div class="hidden md:block absolute top-6 left-[10%] right-[10%] h-0.5 bg-gradient-to-r from-teal-900 via-brand-500/50 to-teal-900 z-0"></div>
                    ...
                    <div class="grid md:grid-cols-4 gap-12 text-center relative z-10">
                        @foreach([
                            ...
                            <div class="reveal delay-{{ $i + 1 }} group">
                                <div class="w-12 h-12 mx-auto bg-teal-950 border-4 border-teal-900 rounded-full flex items-center justify-center mb-6 relative group-hover:scale-110 transition-transform duration-300">
                                ...
                                <p class="text-sm text-[#f4f7f6]/80 font-medium">{{ $milestone['desc'] }}</p>
                            </div>
                        @endforeach
                    </div>
                </div>
        ...
        <section class="py-32 relative overflow-hidden bg-white/30">
            ...
            <div class="max-w-3xl mx-auto px-4 text-center relative z-10 reveal">
                <h2 class="font-serif text-5xl md:text-6xl font-extrabold mb-8 tracking-tight text-[#0f2d2a]">
                    Ready to <span class="text-brand-600 italic">Modernize?</span>
                </h2>
                <p class="text-[#0f2d2a]/80 mb-12 text-lg md:text-xl font-semibold">Join the growing network of modern diagnostic labs experiencing zero downtime and automated workflows.</p>
                
                <a href="{{ route('enquiry') }}" class="inline-flex justify-center items-center gap-2 px-10 py-5 bg-[#0c5f56] text-white hover:bg-[#094d45] rounded-full font-bold text-lg shadow-xl shadow-teal-900/10 transition-all duration-300 transform hover:-translate-y-1 active:scale-95">
