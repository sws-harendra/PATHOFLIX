...
<div class="fixed top-0 inset-x-0 z-[100] flex justify-center px-4 pt-4 pointer-events-none">
    <nav x-data="{ open: false, scrolled: false }" 
       ...
       download
       :class="scrolled ? 'py-2 px-5 text-[10px]' : 'py-3 px-6 text-xs'"
       class="hidden lg:flex uppercase tracking-wider font-bold text-white bg-green-600 hover:bg-green-700 rounded-full transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95 whitespace-nowrap">
        Download App
    </a>
                <!-- <a href="{{ url('/#contact') }}"
                   :class="scrolled ? 'py-2 px-5 text-[10px]' : 'py-3 px-6 text-xs'"
