    ...
    <div class="pos-container">
        ...
        <div class="container-fluid pt-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 px-2">
                <h4 class="mb-0 fw-bold"><i class="feather-edit-3 me-2 text-primary"></i>Edit Invoice — {{ $invoice->invoice_number }}</h4>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('lab.pos') }}">POS</a></li>
            ...
            <div class="row g-0">
                    ...
                    <div class="pos-card">
                        ...
                        <div class="card-body p-3">
                            <select class="form-select-pos" wire:change="addTestToCart($event.target.value)">
                                ...
                                @foreach(\App\Models\LabTest::where('company_id', auth()->user()->company_id)->where('is_package', true)->get() as $pkg)
                ...
                <div class="col-md-4 px-2">
                    ...
                    <div class="pos-card">
                        ...
                        <div class="card-body p-3">
                            <div class="text-muted small">This booking is linked to the main lab by default.</div>
                        </div>
                    </div>
        ...
        <div class="bottom-actions container-fluid">
            <button wire:click="updateBill" class="btn-action btn-save shadow-sm">
                <i class="feather-save me-2"></i>Update & Save Invoice
            </button>
            <a href="{{ route('lab.pos.summary', $invoice->id) }}" wire:navigate class="btn-action btn-cancel shadow-sm text-center text-decoration-none">
                <i class="feather-x-circle me-2"></i>Cancel & Back
            </a>
        </div>
