...
class LabTest extends Model
{
    ...
    protected $fillable = [
        ...
        'mrp', 'b2b_price', 'sample_type', 'tat_hours', 'parameters', 'is_active', 'description' , 'interpretation', 'show_interpretation', 'show_notes', 'is_package', 'linked_test_ids', 'is_culture',
    ];
